...
<main>
  <section class="w-full min-h-screen mx-auto flex justify-between gap-2">
    <div class="w-full flex justify-center">
      <div class="w-[80%] md:w-1/2 px-20 flex flex-col items-center justify-center text-center my-4">
        <div class="w-full h-full flex flex-col justify-center">
          ...
          <div class="flex flex-col items-center justify-center py-2 px-0 lg:px-8">
            <form action="<?= base_url('loginAction') ?>" method="POST" class="w-full flex flex-col gap-y-6 mt-10">
              ...
              <input id="password" name="password" type="password" placeholder="masukan password anda"
                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-3 py-2" />
              <div class="mt-4 items-center justify-center">
                <button type="submit"
                  class="rounded-md w-full bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 duration-300">
                  Masuk
                </button>
              </div>
            </form>
            <div class="mt-6">
              belum punya akun? registrasi <a href="<?= base_url('register') ?>" title="Registrasi"
